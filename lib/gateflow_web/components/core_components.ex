defmodule GateflowWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(GateflowWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(GateflowWeb.Gettext, "errors", msg, opts)
    end
  end
